...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { description: @treatment.description, img_link: @treatment.img_link, name: @treatment.name, pos: @treatment.pos }
    end
  ...
  test "should update treatment" do
    put :update, id: @treatment, treatment: { description: @treatment.description, img_link: @treatment.img_link, name: @treatment.name, pos: @treatment.pos }
    assert_redirected_to treatment_path(assigns(:treatment))
  end

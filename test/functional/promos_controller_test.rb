...
class PromosControllerTest < ActionController::TestCase
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post :create, promo: { description: @promo.description, img_link: @promo.img_link, name: @promo.name, pos: @promo.pos }
    end
  ...
  test "should update promo" do
    put :update, id: @promo, promo: { description: @promo.description, img_link: @promo.img_link, name: @promo.name, pos: @promo.pos }
    assert_redirected_to promo_path(assigns(:promo))
  end
